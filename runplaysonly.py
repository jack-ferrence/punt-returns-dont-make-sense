...
punts = df[df['play_type'].str.lower() == 'run']

# Save to a new CSV, or overwrite the old one if you prefer
punts.to_csv('/Users/jackferrence/Desktop/CombineNFLData/nfl_pbp_2009_2019_run_only.csv', index=False)

print(f"Filtered dataset: {len(punts)} punt plays saved to nfl_pbp_2009_2019_run_only.csv")
